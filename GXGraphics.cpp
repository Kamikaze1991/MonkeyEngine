...
void GXGraphics::buildDescriptorHeaps()
{
	...
	mDevice->CreateDescriptorHeap(&mRtvHeapDesc, IID_PPV_ARGS(mDsvHeap.GetAddressOf()));
	...
	mDevice->CreateDescriptorHeap(&mDsvHeapDesc, IID_PPV_ARGS(mDsvHeap.GetAddressOf()));
}
